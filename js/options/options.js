...
document.querySelector("#changelog_set").innerHTML=text("changelog_set").replace(/<[^>]+>/,'<a href="#" id="full-log title="'+text("changelog_set_desc")+'">\"'+text("fulllog")+'\"</a>:&nbsp');
document.querySelector("#onlog").options[0].innerText=text("changelog_set_opt_1");
document.querySelector("#onlog").options[1].innerText=text("changelog_set_opt_2").replace(/<[^>]+>/,"Changelog.txt");
