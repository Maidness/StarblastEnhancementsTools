...
let output;
var indent=39;
if (typeof localStorage.request === 'undefined') localStorage.setItem("request",1);
...
function convert()
{
  ...
  try {
    ...
    err.setAttribute("style","width:330px;position:absolute;left: 50%;margin-left: -50px;top: 10px;background-color:#09161c;text-align:center;border:5px #09161c solid;border-left:3px #FFFF33 solid;border-radius:5px;animation: fadeInOut 5s");
